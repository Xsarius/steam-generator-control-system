...
function reloadData() {
  ...
  document.getElementById("active_power_ph1").textContent = json_data["active_power_ph1"];
  // Phase 2 
  ...
  document.getElementById("active_power_ph2").textContent = json_data["active_power_ph2"];
  //Phase 3
  ...
  document.getElementById("active_power_ph3").textContent = json_data["active_power_ph3"];
